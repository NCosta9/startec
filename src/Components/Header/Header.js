...
export default function Header() {
  return (
    <>
      <section id="topbar" className="d-flex align-items-center  d-none d-sm-block">
      ...
      <header id="header" className="d-flex align-items-center">
        <div className="container d-flex align-items-center justify-content-between">
          ...
          <nav id="navbar" className="navbar">
            <ul>
              <li><AnchorLink className="nav-link scrollto active" href="#hero">Home</AnchorLink></li>
              <li><AnchorLink className="nav-link scrollto" href="#about">Sobre</AnchorLink></li>
              <li><AnchorLink className="nav-link scrollto" href="#services">Serviços</AnchorLink></li>
              <li><a className="nav-link scrollto " href="#portfolio">Portfolio</a></li>
              <li><AnchorLink className="nav-link scrollto" href="#clients">Clientes</AnchorLink></li>

              <li><AnchorLink className="nav-link scrollto" href="#pricing">Produtos</AnchorLink></li>

              <li><AnchorLink className="nav-link scrollto" href="#contact">Contato</AnchorLink></li>
            </ul>
